...
This repository contains several Python projects developed as part of my coursework in artificial intelligence, data analysis, software testing, machine learning, deep learning, robotics, and data structures. Each project is designed to focus on a specific area of computer science and software engineering.
...
- Designing and evaluating deep learning models for image classification and time-series anomaly detection  
- Building vision-based robotics systems using OpenCV, JetBot robots, camera input, and motor control  
...
- Developing classic and advanced data structures such as linked lists, trees, graphs, and heaps from scratch in Python  
